...
export class SettingsPage {
    ...
    constructor(private _app: App, public push: Push, public nav: NavController, public navParams: NavParams, public platform: Platform, public apiServ: ApiService, public modal: ModalController, public alert: AlertController, public toast: ToastController, public loading: LoadingController) {
        platform.ready().then(() => {
    ...
    goToLogOut() {
        ...
        loader.onDidDismiss(() => {
            if (this.response.status != "success") {
                ...
                this.push.unregister().then(() => { }, (error) => { });
                this.goToHome();
            }
        });
        loader.present();
